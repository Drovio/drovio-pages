...
$page->build($pageTitle, "HelpCenterPageContainer", TRUE, TRUE);
$sidebarContainer = HTML::select(".HelpCenterPage .help-sidebar")->item(0);

// Load navigation bar on mainpage
$navBar = HTML::select(".HelpCenterPage .help-mainpage .navbar")->item(0);
