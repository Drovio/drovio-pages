...
$requestSection = (empty($requestSection) || !empty($appInitName) ? "apps" : $requestSection);
...
$startupBundleID = $st->get("enp_startup_bundle");
if (!empty($startupBundleID))
{
	$pb = new projectBundle($startupBundleID);
