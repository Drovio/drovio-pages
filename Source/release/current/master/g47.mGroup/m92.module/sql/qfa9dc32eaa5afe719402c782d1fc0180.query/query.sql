SELECT AC_app.id, DEV_project.title, DEV_projectRelease.title as rTitle, DEV_project.name, DEV_project.description, DEV_projectRelease.version, DEV_projectRelease.changelog
FROM AC_app
