...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$success = $bugger->setSeverity($_POST['bid'], $_POST['severity']);
...
// Build the module 
$MContent->build("", "changeBugSeverity inlineForm", TRUE);

$formContent = HTML::select('.changeBugSeverity .actionForm ')->item(0);

$sForm = new simpleForm();
$sForm->build($moduleID, "changeBugSeverity", FALSE);
...
$resource = bugTracker::getSeverityOptions();
$input = $sForm->getResourceSelect("severity", $multiple = FALSE, $class = "", $resource, bugTracker::SV_MINOR );
