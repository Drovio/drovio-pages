...
$whiteBox = HTML::select(".projectSettings .whiteBox")->item(0);
...
{
	$ref = $class."_ref";
	$navItem = HTML::select(".projectSettings .menu .menu_item.".$class)->item(0);
	$page->setStaticNav($navItem, $ref, $targetcontainer = "settingsContainer", $targetgroup = "mGroup", $navgroup = "prj_st_group", $display = "none");
