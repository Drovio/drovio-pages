...
// Set common docs
$menu["common_welcomepage"] = "Welcome";
$menu["common_gettingstarted"] = "GettingStarted";
$menu["common_bestpractices"] = "BestPractices";

// Set Tutorials
$menu['tutorial_identityapp'] = "Tutorials/IdentityApp";
$menu['tutorial_relationsapp'] = "Tutorials/RelationsApp";
//$menu['tutorial_helloworld'] = "Tutorials/HelloWorld";

// Identity api
$menu["identity_api"] = "APIs/Identity/API";
$menu["social_login"] = "APIs/Identity/SocialLogins";
$menu["auth_tokens"] = "APIs/Identity/AuthTokens";
$menu["api_partners"] = "APIs/Identity/APIPartners";
