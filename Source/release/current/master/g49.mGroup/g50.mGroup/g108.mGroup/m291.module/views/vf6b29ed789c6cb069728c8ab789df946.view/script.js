...
jq(document).one("ready", function() {
	...
	jq(document).on("keyup", ".sdkManualContainer .navigationContainer .searchInput", function(ev) {
		...
		var matchItems = jq(".sdkManualContainer .objectExplorer .sdkObject").filter(function() {
			return regEx.exec(jq(this).text());
		}).clone(true).addClass("sr");
		...
		var matchItems = jq(".sdkManualContainer .objectExplorer .wsdkObject").filter(function() {
			return regEx.exec(jq(this).text());
		}).clone(true).addClass("sr");
