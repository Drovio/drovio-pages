...
$menuItem = $tMenu->build("", "", "vNavTool create_new")->get();
...
// New package
$title = moduleLiteral::get($moduleID, "lbl_createViewFolderTitle");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "createViewFolder", "", $attr);

// New namespace
$title = moduleLiteral::get($moduleID, "lbl_createViewTitle");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "createView", "", $attr);

// New object
$title = moduleLiteral::get($moduleID, "lbl_deleteViewFolderTitle");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "deleteViewFolder", "", $attr);
