...
$viewModuleID = engine::getVar('mid');
$viewID = engine::getVar('vid');
...
$actionFactory->setModuleAction($literalEditorTool, $innerModules['literalEditor'], "", "", $attr, $loading = TRUE);
...
$attr['mid'] = $viewModuleID;
$attr['vid'] = $viewID;
$actionFactory->setModuleAction($delTool, $moduleID, "deleteView", "", $attr, $loading = TRUE);
...
$mainViewTabber = $tabber->build($id = "tbr_".$itemID, FALSE, FALSE)->get();
HTML::addClass($mainViewTabber, "moduleViewTabControl");
...
$editor = new codeMirror($type = codeMirror::PHP, $name = "viewSource");
$code = $viewObject->getPHPCode();
$objectEditor = $editor->build($code, "", "cmEditor codeEditorContainer")->get();
...
$editor = new WViewEditor($cssName = "viewCss", $htmlName = "viewHtml");
...
$editor = new codeMirror($type = codeMirror::JS, $name = "viewJS");
$code = $viewObject->getJSCode();
$objectEditor = $editor->build($code, "", "cmEditor")->get();
DOM::append($editorOuterContainer, $objectEditor);
