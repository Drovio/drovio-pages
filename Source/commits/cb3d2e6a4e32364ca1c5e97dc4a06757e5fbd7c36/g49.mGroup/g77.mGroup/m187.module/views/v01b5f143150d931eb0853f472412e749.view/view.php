...
// Project Home
$subItem = $page->addToolbarNavItem("projectHome", $projectTitle, $class = "project", NULL, $ribbonType = "float", $type = "obedient toggle", $ico = TRUE);
// Set navigation
$url = url::resolve("developer", "/projects/project.php");
$params = array();
$params['id'] = $projectID;
$href = url::get($url, $params);
HTML::attr($subItem, "href", $href);
HTML::attr($subItem, "target", "_self");
$actionFactory->setModuleAction($subItem, $innerModules['projectHome'], "", "", $params);
