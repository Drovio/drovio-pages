...
// Inner Module Codes
$innerModules = array();
$innerModules['accountInfo'] = on;
$innerModules['teamManager'] = on;
$innerModules['teamPage'] = on;
...
$items = array();
$items["myTeams"] = "myTeams";
$items["myRelations"] = "";
$items["myCollaborations"] = "";
$items["myInvitations"] = "myInvitations";
...
$navItem = HTML::select(".myRelations .navItem.myInvitations")->item(0);
