...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$page = new wsPage($_POST['id'], $parent);
	$success = $page->create($_POST['name']);
	...
	if (!$success )
	{
		...
		// Description
		$formErrorNotification->addErrorDescription($err_header, $descriptionId, "Error", $extra = "Error creating page.");
		return $formErrorNotification->getReport();
	}
