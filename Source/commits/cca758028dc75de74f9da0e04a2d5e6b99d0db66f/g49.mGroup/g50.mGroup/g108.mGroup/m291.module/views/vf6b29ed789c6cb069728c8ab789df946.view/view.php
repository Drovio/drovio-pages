...
$activeManual = FALSE;
if (isset($_GET['domain']) && isset($_GET['lib']) && isset($_GET['pkg']) && isset($_GET['ns']) && isset($_GET['oname']))
	$activeManual = TRUE;

// Build the module content
if ($activeManual)
	$title = $_GET['oname']." | Manual";
else
...
function buildObjTree($navTree, $libName, $packageName, $parentNs, $sourceMap)
{
	...
	foreach ($objs as $key => $value)
	{
		...
		// Set href attributes
		$url = url::resolve("developer", "/docs/sdk/index.php");
