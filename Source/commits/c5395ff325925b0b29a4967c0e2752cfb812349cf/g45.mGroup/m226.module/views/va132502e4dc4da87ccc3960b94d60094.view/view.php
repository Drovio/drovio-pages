...
// Dashboard link
$page->addToolbarNavItem("bsDashboard", team::getTeamName(), "dashboard", NULL);
...
if (count($apps) > 0)
{
	...
	foreach ($apps as $app)
	{
		...
		$appIcon2 = projectLibrary::getPublishedPath($app['project_id'], $app['version'])."/resources/.assets/icon.png";
