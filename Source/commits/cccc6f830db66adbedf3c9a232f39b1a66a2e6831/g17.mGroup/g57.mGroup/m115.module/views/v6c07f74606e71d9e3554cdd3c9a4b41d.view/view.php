...
{
	case 'all':
		$templatesArray = templateManager::getTemplates('','deploy');
		break;	
	case 'project':
		$templatesArray = templateManager::getUserTemplates('','project');
		break;
	case 'my':
		$templatesArray = templateManager::getUserTemplates('','deploy');
		break;
	default:		
		break;		
}
