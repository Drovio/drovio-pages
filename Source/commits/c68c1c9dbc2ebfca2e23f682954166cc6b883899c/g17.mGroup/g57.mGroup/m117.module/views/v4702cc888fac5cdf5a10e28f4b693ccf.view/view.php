...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$attr['hld'] = 'tSnip_'.$themeName;
	$pageStructureItem = $HTMLContent->getModuleContainer($innerModules['componentEditor'], "thItemSnippet", $attr, TRUE, $attr['hld']);
	$HTMLContent->buildElement($pageStructureItem);
	return $HTMLContent->getReport("#thBodyContent", "append");
}

// Build Frame
$frame = new windowFrame();
// Header
$hd = moduleLiteral::get($moduleID, "lbl_addTheme", FALSE);
