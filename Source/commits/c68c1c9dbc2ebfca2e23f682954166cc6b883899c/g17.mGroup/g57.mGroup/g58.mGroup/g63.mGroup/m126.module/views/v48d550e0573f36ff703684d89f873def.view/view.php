...
DOM::appendAttr($visibilitySwitch, 'data-pageSelector', 'close');
$refresh = literal::dictionary("close", $wrapped = TRUE);
...
{
	$item = DOM::create("div");
	$content = moduleLiteral::get($moduleID, "not_noStructure", $attributes = array(), $wrapped = TRUE);
