...
$deletePromtHolder = DOM::create('div', '', '', 'deletePromtHolder noDisplay');
...
$actionFactory->setModuleAction($deleteStructureControl, $innerModules['templateObject'], 'deleteTheme', '', array('templateId' => $templateID, 'objectName' => $objectName, 'holder' => $holder));
