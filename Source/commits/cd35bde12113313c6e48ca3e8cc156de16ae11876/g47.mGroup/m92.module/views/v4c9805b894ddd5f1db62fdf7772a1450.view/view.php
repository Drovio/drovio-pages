...
$menuItems = array();
$menuItems["all_apps"] = "/";
$menuItems["all_categories"] = "/categories/all";
$menuItems["games"] = "/categories/games";
$menuItems["tools"] = "/categories/tools";
...
// Set all apps action
$mitem = HTML::select(".appCenterSidebar .smenu .mitem.all_apps")->item(0);
$actionFactory->setModuleAction($mitem, $moduleID, "appList", ".appCenterContentHolder");
