...
$dc = HTML::select(".quickLinks")->item(0);
$title = moduleLiteral::get($moduleID, "lbl_quickLinks");
$header = HTML::select(".quickLinks h3.title")->item(0);
DOM::append($header, $title);

$headerA = HTML::select(".quickLinks h4")->item(0);
...
$headerA = HTML::select(".quickLinks h4")->item(1);
$url = url::resolve("developer", "/tools/");
$title = moduleLiteral::get($moduleID, "lbl_devTools");
$wl = $page->getWeblink($url, $title, "_blank");
DOM::append($headerA, $wl);

$headerA = HTML::select(".quickLinks h4")->item(2);
