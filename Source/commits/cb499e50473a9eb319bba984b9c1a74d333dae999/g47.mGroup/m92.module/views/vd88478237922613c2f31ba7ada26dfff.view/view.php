...
$appCenterContainer = HTML::select(".appCenter .appCenterContainer")->item(0);
$applicationList = module::loadView($moduleID, "appList");
DOM::append($appCenterContainer, $applicationList);

// Load footer menu
$footerContainer = HTML::select(".appCenter .footerContainer")->item(0);
