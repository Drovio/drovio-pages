...
$page->build($title, "applicationInfoContainerPage", TRUE);
...
$appInfoViewerContainer = HTML::select(".applicationInfoContainer .appInfoViewerContainer")->item(0);
$applicationList = module::loadView($moduleID, "applicationInfoViewer");
DOM::append($appInfoViewerContainer, $applicationList);

// Load footer menu
$footerContainer = HTML::select(".applicationInfoContainer .footerContainer")->item(0);
