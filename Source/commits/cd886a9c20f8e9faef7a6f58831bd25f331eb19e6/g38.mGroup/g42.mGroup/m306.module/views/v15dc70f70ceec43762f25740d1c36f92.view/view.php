...
$page->build($title, "RedbackAcceptableUsagePage", TRUE);


// Load Terms of Use Document
$wDoc = new wDoc("", "Policies/AcceptableUse");
$documentContent = $wDoc->load($locale = NULL, $public = TRUE, $teamID = 6);

$docContainer = HTML::select(".usagePage .docContainer")->item(0);
...
// Load footer menu
$discoverPage = HTML::select(".usagePage")->item(0);
