...
// Hidden Values
//_____ Website ID
$input = $form->getInput("hidden", "wid", $websiteID, $class = "", $autofocus = FALSE);
$form->append($input);
//_____ Library
$input = $form->getInput("hidden", "lib", $obj_libName, $class = "", $autofocus = FALSE);
$form->append($input);
//_____ Package
$input = $form->getInput("hidden", "pkg", $obj_packageName, $class = "", $autofocus = FALSE);
$form->append($input);
//_____ Namespace
$input = $form->getInput("hidden", "ns", $obj_nsName, $class = "", $autofocus = FALSE);
$form->append($input);
//_____ Object ID
$input = $form->getInput("hidden", "oid", $obj_objectName, $class = "", $autofocus = FALSE);
$form->append($input);
