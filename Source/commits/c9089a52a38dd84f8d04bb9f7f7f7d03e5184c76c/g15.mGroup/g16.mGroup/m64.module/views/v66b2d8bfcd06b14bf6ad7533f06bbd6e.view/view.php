...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if ($empty)
	{
		...
		// Header
		$err_header = moduleLiteral::get($moduleID, "queryTitle");
...
$frame->build("Create new View", $moduleID, "newModuleQuery", FALSE);

$sForm = new simpleForm();

// Header
$hdr = moduleLiteral::get($moduleID, "info.newModuleQueryPrompt");
