...
if ($teamAdmin)
{
	...
	// Set delete team action
	$deleteTeamButton = HTML::select(".teamSettings .sidebar .pr_delete_team")->item(0);
	$actionFactory->setModuleAction($deleteTeamButton, $moduleID, "deleteTeam");
}
else
{
	// Remove navitems
