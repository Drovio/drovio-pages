...
if (engine::isPost())
{
	...
	switch ($_POST['ptype'])
	{
		...
		case "template":
			break;
		case "module":
			page::engageModule($pageID, $_POST['module']['mid'], $static = 1, $_POST['module']['attr']);
			break;
	}
...
$typeResource['template'] = "Load from Template";
...
$templateWrapper = DOM::create("div", "", "", "pageContentWrapper template");
$form->append($templateWrapper);
...
$title = moduleLiteral::get($moduleID, "hd_templateContent");
$hd = DOM::create("h3", $title, "", "hd");
DOM::append($templateWrapper, $hd);
...
$moduleGroupInput = $form->getResourceSelect($name = "module[group]", $multiple = FALSE, $class = "", $moduleGroups, $selectedValue = $pageData['moduleGroup_id']);
...
$moduleInput = $form->getResourceSelect($name = "module[mid]", $multiple = FALSE, $class = "", $modules, $selectedValue = $pageData['module_id']);
