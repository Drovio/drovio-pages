...
if (engine::isPost())
{
	...
	foreach ($_POST['settings'] as $sname => $svalue)
		$ts->set($sname, $svalue);
...
// Team unique name
$title = moduleLiteral::get($moduleID, "lbl_team_uname");
$notes = moduleLiteral::get($moduleID, "lbl_team_uname_ph", array(), FALSE);
...
// Team public profile
$title = moduleLiteral::get($moduleID, "lbl_team_public_profile");
$input = $form->getInput($type = "checkbox", $name = "settings[public_profile]", 1, $class = "");
