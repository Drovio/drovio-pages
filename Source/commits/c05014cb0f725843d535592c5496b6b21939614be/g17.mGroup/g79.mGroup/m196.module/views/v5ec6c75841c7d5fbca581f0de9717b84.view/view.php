...
$innerModules['templates'] = on;
$innerModules['themes'] = on;
$innerModules['literalEditor'] = on;
...
if (empty($projectName) && !empty($projectInfo['name']))
{
	...
	$url = url::resolve("web", "/websites/".$projectName);
...
// Build module page
$page->build($projectTitle, "webDesignerPage", TRUE, TRUE);
...
foreach ($sections as $section)
{
	...
	if (empty($projectName))
	{
		...
		$url = url::resolve("web", "/websites/".$projectName."/".$section."/");
