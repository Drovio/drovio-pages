...
// Project Tester
$title = moduleLiteral::get($moduleID, "lbl_projectTestingTitle");
$repositoryBtn = HTML::select(".tester .title")->item(0);
...
$attr = array();
$attr['id'] = $projectID;
$actionFactory->setModuleAction($wl, $innerModules['projectTesterPreview'], "", "", $attr);
