...
// Developer Home
$header = moduleLiteral::get($moduleID, "tlb_homeNav_developer");
$url = url::resolve("admin", $url = "/developer/", $https = FALSE, $full = FALSE);
$item = getNavMenuItem($header, $actionFactory, $innerModules['devHomePage'], $url);
DOM::append($navMenu, $item);
...
// Security Manager
$header = moduleLiteral::get($moduleID, "lbl_securityManager");
$url = url::resolve("admin", $url = "/security/", $https = FALSE, $full = FALSE);
$item = getNavMenuItem($header, $actionFactory, $innerModules['securityManager'], $url);
DOM::append($navMenu, $item);

// Resources Manager
$header = moduleLiteral::get($moduleID, "tlb_homeNav_resources");
$url = url::resolve("admin", $url = "/resources/", $https = FALSE, $full = FALSE);
$item = getNavMenuItem($header, $actionFactory, $innerModules['resourcesPage'], $url);
DOM::append($navMenu, $item);
