...
if (count($updates) > 0)
{
	...
	$updateInfo = array();
	$updateInfo['title'] = $pageContent->getLiteral("ntf_updates_available", array(), FALSE);
	$updateInfo['action_title'] = $pageContent->getLiteral("ntf_updates_available.update", array(), FALSE);
