...
$title = moduleLiteral::get($moduleID, "lbl_rfolders");
$item = $sMenu->insertListItem("wsRFolder", $title);
$sMenu->addNavigation($item, $ref = "wsPage_rfolder", $targetcontainer, $targetgroup, $navgroup, $display);
...
$ref_element = HTML::select("#wsPage_rfolder")->item(0);
$sMenu->addNavigationSelector($ref_element, $targetgroup);
...
$form = new simpleForm();
$folderForm = $form->build()->engageModule($moduleID, "deleteFolder")->get();
DOM::append($folderFormContainer, $folderForm);
