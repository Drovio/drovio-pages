...
// Get variables
$websiteID = $_GET['id'];
$pageFolder = $_GET['parent'];
$pageName = $_GET['name'];

$itemID = $websiteID."_".str_replace("/", "_", $pageFolder)."_".$pageName;
...
// Page folder
$input = $form->getInput("hidden", "parent", $pageFolder, $class = "", $autofocus = FALSE);
$form->append($input);
