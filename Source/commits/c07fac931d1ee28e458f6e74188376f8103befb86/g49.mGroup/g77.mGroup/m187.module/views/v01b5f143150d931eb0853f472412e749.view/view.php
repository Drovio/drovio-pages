...
$designer = $page->getModuleContainer($designerModuleID, $action = "", $attr, $startup = TRUE, $containerID = "projectDesigner", $loading = FALSE, $preload = FALSE);
$page->append($designer);


// Add project hints
$hints = $page->getModuleContainer($moduleID, $action = "hintsPopup", $attr = array(), $startup = TRUE, $containerID = "projectHintsContainer");
$page->append($hints);
