...
// SDK Libraries Tab
$SDKContainer = $page->getModuleContainer($innerModules['sdkManager'], "packageViewer", $attr = array(), $startup = TRUE, $containerID = "", $loading = FALSE, $preload = TRUE);
$coreTabber->insertTab("sdkTab", "SDK", $SDKContainer, TRUE);

// SQL Query Tab
$SQLContainer = $page->getModuleContainer($innerModules['sqlManager'], "queryExplorer", $attr = array(), $startup = TRUE, $containerID = "", $loading = FALSE, $preload = TRUE);
$coreTabber->insertTab("sqlTab", "SQL", $SQLContainer, FALSE);

// Ajax Page Tab
$AjaxContainer = $page->getModuleContainer($innerModules['ajaxManager'], "ajaxExplorer", $attr = array(), $startup = TRUE, $containerID = "", $loading = FALSE, $preload = TRUE);
