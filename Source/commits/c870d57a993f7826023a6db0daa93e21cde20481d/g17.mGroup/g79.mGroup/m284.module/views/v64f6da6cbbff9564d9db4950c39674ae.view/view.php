...
// Build Form
$form = new simpleForm();
$form->build("", FALSE)->engageModule($moduleID, "websitePublisher");
...
$title = moduleLiteral::get($moduleID, "lbl_publishWebsite");
...
$frame->build($title, "wsPublisherFrame", $background = TRUE);
