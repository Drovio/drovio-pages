...
HTML::innerHTML($vcsVersion, "Repository Controller");
...
// Commits
$title = DOM::create("span", "Commits (".$vcsInfo['commitsCount'].")");
...
// Branches
$title = DOM::create("span", "Branches (".$vcsInfo['branchesCount'].")");
...
// Releases
$title = DOM::create("span", "Releases (".$vcsInfo['releasesCount'].")");
