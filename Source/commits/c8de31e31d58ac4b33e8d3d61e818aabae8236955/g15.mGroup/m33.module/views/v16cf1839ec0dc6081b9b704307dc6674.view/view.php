...
// Page Explorer
$header = moduleLiteral::get($moduleID, "tlb_securityNat_pages");
$url = url::resolve("admin", $url = "/security/pages/", $https = FALSE, $full = FALSE);
$item = getNavMenuItem($header, $actionFactory, $innerModules['pageExplorer'], $url);
DOM::append($navMenu, $item);
