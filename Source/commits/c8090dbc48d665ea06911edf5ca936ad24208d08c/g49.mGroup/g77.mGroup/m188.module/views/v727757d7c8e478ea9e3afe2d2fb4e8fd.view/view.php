...
if ($currentPage > 0)
{
	...
	$actionFactory->setModuleAction($newerBtn, $moduleID, "repositoryCommits", "#commits_container", $attr);
}
...
if (($currentPage + 1) * $pageNumCommits < $totalCommitCount)
{
	...
	$attr['bn'] = $branchName;
	$attr['page'] = $currentPage + 1;
	$actionFactory->setModuleAction($olderBtn, $moduleID, "repositoryCommits", "#commits_container", $attr);
}
