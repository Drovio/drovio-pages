...
$panelItem = $panel->insertPanelItem($type = "small", $title, $imgURL = "", $selected = FALSE);
$actionFactory->setPopupAction($panelItem, $moduleID, "createAppStyle", $attr);
$title = moduleLiteral::get($moduleID, "lbl_scriptObject");
$panelItem = $panel->insertPanelItem($type = "small", $title, $imgURL = "", $selected = FALSE);
$actionFactory->setPopupAction($panelItem, $moduleID, "createAppScript", $attr);
DOM::append($navCollection, $rPanel);
...
$panelItem = $panel->insertPanelItem($type = "small", $title, $imgURL = "", $selected = FALSE);
$actionFactory->setPopupAction($panelItem, $moduleID, "createAppView", $attr);
DOM::append($navCollection, $rPanel);
...
$viewer = $splitter->build($orientation = "horizontal", $layout = gridSplitter::SIDE_RIGHT, $closed = FALSE, "Explorer")->get();
...
$attr = array();
$attr['appID'] = $_GET['projectID'];
$viewerContainer = $page->getModuleContainer($moduleID, "appExplorer", $attr);
