...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	{
//		$success = page::delete($_POST['pageId']);
	...
	$success = page::update($_POST['pageId'], $_POST['module'], $_POST['title'], $_POST['folder'], $static, $sitemap, $_POST['attributes']);
...
// Connection Toolbar attribute
$title = moduleLiteral::get($moduleID, "lbl_pageAttr_connection");
$input = $sForm->getInput($type = "checkbox", $name = "attributes[no_connection]", $value = "1", $class = "", $autofocus = FALSE);
if ($pageData['attributes']['no_connection'])
	DOM::attr($input, "checked", "checked");
$libRow = $sForm->buildRow($title, $input, $required = FALSE, $notes = "");
$sForm->append($libRow);
