...
$packages = importer::getOpenPackageList();
...
foreach ($appManifests as $mfID)
{
	...
	$packages = array_merge($packages, $mfInfo['packages']);
}
...
// Send redWIDE Tab
$WIDETab = new redWIDE();
return $WIDETab->getReportContent($objID, $viewName, $pageContent->get());
//#section_end#
?>