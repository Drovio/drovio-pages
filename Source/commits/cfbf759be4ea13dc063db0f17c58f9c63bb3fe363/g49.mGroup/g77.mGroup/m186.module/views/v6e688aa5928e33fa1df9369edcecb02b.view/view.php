...
$designerBtn = HTML::select(".projectDesigner")->item(0);
...
$repositoryBtn = HTML::select(".projectRepository")->item(0);
...
$addMemberBtn = HTML::select(".projectMembers .addMember")->item(0);
DOM::append($addMemberBtn, $title);

// Set add action
$attr = array();
$attr['id'] = $projectID;
$actionFactory->setModuleAction($addMemberBtn, $moduleID, "addProjectMember", "", $attr);
