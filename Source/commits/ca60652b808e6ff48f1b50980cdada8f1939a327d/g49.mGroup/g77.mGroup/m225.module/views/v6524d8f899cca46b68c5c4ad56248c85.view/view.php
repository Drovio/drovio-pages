...
// Get project status
$prStatus = HTML::select(".projectOverview .status .projectStatus")->item(0);
$prStatusTitle = HTML::select(".projectOverview .status .projectStatus .title")->item(0);
...
// Project Health
$prHealthTitle = HTML::select(".projectOverview .status .projectHealth .title")->item(0);
