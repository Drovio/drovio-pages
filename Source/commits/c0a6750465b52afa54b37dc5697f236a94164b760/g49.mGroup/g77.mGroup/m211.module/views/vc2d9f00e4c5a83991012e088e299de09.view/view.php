...
if (engine::isPost())
{
	...
	if ($dbc->get_num_rows($result) > 0)
	{
		...
		privileges::addAccountToGroupID($accountID, $_POST['role']);
		accountKey::create($_POST['role'], 2, $projectID, $accountID);
	}
	...
	if ($status)
	{
		...
		$errorMessage = DOM::create("p", "Project member successfully added.");
