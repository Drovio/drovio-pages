...
// Return response
return $respContent->getResponse($allowOrigin = $applicationHeaderArray['Access-Control-Allow-Origin'], $withCredentials = $applicationHeaderArray['Access-Control-Allow-Credentials']);
//#section_end#
?>