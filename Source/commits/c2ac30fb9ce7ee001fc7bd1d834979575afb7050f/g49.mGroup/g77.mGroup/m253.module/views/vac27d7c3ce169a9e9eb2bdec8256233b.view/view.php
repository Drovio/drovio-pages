...
$attr = array();
$attr['id'] = $projectID;
$scopeContainer = $pageContent->getModuleContainer($moduleID, $action = "scopeExplorer", $attr, $startup = TRUE, $containerID = "", $loading = FALSE, $preload = TRUE);
...
// Get image
$lastVersion = projectLibrary::getLastProjectVersion(modulesProject::PROJECT_ID);
$publishFolder = projectLibrary::getPublishedPath(modulesProject::PROJECT_ID, $lastVersion);
$resourcePath = $publishFolder."/media";
$resourcePath = str_replace(paths::getPublishedPath(), "", $resourcePath);
$resourcePath .= "/geo/flags/".$localeInfo['imageName'];
$localeImageUrl = url::resolve("lib", $resourcePath);
