...
// Get project status
$prStatus = HTML::select(".wsOverview .boxStatus.project")->item(0);
$prStatusTitle = HTML::select(".wsOverview .boxStatus.project .title")->item(0);
...
// Check server status
$serverStatus = 0;
$srvStatus = HTML::select(".wsOverview .boxStatus.server")->item(0);
$srvStatusTitle = HTML::select(".wsOverview .boxStatus.server .title")->item(0);
switch ($serverStatus)
{
	case 2:
...
$wsPublisher = HTML::select(".wsOverview .boxStatus.project .configure")->item(0);
$attr = array();
$attr['id'] = $projectID;
