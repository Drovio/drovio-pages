...
$pageContent->build("", "teamSelectorContainer", TRUE);

// Get account teams
$teamContainer = HTML::select(".teamSelector .teams")->item(0);
...
// Team name
$ph = $pageContent->getLiteral("lbl_teamName", array(), FALSE);
...
// Button
$title = $pageContent->getLiteral("lbl_create");
