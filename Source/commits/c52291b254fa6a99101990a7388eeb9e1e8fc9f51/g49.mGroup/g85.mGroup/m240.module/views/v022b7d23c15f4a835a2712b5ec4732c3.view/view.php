...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if ($empty)
	{
		...
		$err = $errFormNtf->addErrorHeader("moduleTitle_h", $err_header);
		$errFormNtf->addErrorDescription($err, "moduleTitle_desc", $errFormNtf->getErrorMessage("err.required"));
	}
...
$frame->build($title, $moduleID, "newModuleView", FALSE);
