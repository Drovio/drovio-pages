...
if (engine::isPost())
{
	...
	logger::log("Conection to ".$serverInfo['address']." ".($status ? "SUCCESS" : "FAIL"), logger::DEBUG);
	...
	// Usually : 'httpdocs'
	// TODO: Check if folder exists and create it
	ftp_chdir($conn, $serverInfo['httpdocs']);
