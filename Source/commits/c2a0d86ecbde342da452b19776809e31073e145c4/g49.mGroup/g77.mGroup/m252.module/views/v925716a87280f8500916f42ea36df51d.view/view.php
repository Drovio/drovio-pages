...
{
	// Build page
	$page->build("Project Not Found", "projectLocalizationPage");
...
$page->build($projectTitle." | ".$title, "projectLocalizationPage", TRUE);
