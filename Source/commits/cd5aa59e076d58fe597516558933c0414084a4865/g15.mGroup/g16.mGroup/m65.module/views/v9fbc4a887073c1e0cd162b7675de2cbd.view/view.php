...
// Settings button
$headersTool = DOM::create("div", "", "", "objTool settings");
...
$moduleHeader_title = moduleLiteral::get($moduleID, "lbl_viewInfo");
...
// Module ID [temp?]
$moduleId_title = DOM::create('span', $viewModuleID);
...
$hd = moduleLiteral::get($moduleID, "lbl_dependencies");
$hdr = DOM::create('h2', $hd, "", "lhd hd2");
...
// Header
$hd = moduleLiteral::get($moduleID, "lbl_innerModules");
