...
// Build the module
$page->build($pageTitle, "devModulePage");

// _____ Toolbar Navigation
$vcsItem = $page->addToolbarNavItem("moduleVCS", $title = "VCS", $class = "vcs");
$actionFactory->setPopupAction($vcsItem, $moduleID, "moduleCommitManager");
...
$panel = new ribbonPanel();
$newModAux = $panel->build("moduleCreator", TRUE)->get();
...
$attr['type'] = "aux";
$actionFactory->setModuleAction($newAuxItem, $moduleID, "newModuleView");
