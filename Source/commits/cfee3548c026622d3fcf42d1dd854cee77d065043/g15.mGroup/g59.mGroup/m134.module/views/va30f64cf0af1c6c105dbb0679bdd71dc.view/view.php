...
// Save Tool
$saveTool = DOM::create("div", "", "", "sideTool save");
ModuleProtocol::addActionPOST($saveTool, $moduleID, "sourceCode");
...
// Save Tool
$saveTool = DOM::create("div", "", "", "sideTool save");
ModuleProtocol::addActionPOST($saveTool, $moduleID, "jsCode");
$tlb->insertTool($saveTool);
...
// Save Tool
$saveTool = DOM::create("div", "", "", "sideTool save");
ModuleProtocol::addActionPOST($saveTool, $moduleID, "objModel");
$tlb->insertTool($saveTool);
