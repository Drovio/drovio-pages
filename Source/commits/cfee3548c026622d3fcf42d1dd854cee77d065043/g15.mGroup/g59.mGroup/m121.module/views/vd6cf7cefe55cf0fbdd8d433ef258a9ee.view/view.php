...
$page->build($pageTitle, "devEbuilderAPI");


//____________________ Build Top Navigation ____________________//
// _____ Toolbar Navigation
$vcsItem = $page->addToolbarNavItem("ebldVCS", $title = "VCS", $class = "vcs");
...
ModuleProtocol::addActionGET($new_libItem, $moduleID, "createLibrary");
//___ Package
$pkgTitle = moduleLiteral::get($moduleID, "lbl_package");
$new_pkgItem = $new_libPanel->insertPanelItem($type = "small", $title = $pkgTitle);
ModuleProtocol::addActionGET($new_pkgItem, $moduleID, "createPackage");
...
ModuleProtocol::addActionGET($new_nsItem, $moduleID, "createNamespace");
//___ Object
$objTitle = moduleLiteral::get($moduleID, "lbl_item");
$new_objItem = $new_objPanel->insertPanelItem($type = "small", $title = $objTitle);
ModuleProtocol::addActionGET($new_objItem, $moduleID, "createObject");
...
$apiElementsViewer = DOM::create("div", "", "ebuilderAPIViewer");
$splitter->appendToSide($apiElementsViewer);

// Acquire browsing info
$ebuilderAPIViewer = HTMLModulePage::getModuleContainer($moduleID, "ebuilderAPIViewer");
