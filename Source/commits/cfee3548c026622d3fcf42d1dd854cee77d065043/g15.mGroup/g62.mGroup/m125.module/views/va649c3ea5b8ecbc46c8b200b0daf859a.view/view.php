...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$appObject = new appObject($libName, $packageName, $_POST['namespace']);
	$result = $appObject->create($_POST['objectName'], $_POST['objectDesc'], $has_phpFile, $has_jsFile, $has_cssFile);
...
$packages = $appLib->getPackageList();
