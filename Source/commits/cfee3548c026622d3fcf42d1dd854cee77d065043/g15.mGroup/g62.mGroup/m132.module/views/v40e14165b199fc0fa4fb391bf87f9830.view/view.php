...
$appObj = new appObject($_POST['libID'], $_POST['pkgID'], $_POST['nsID'], $_POST['objID']);
...
{
	$appObj->updateSourceDoc($manual);
	$updated_manual = $appObj->getSourceDoc();
	$strippedCode = documentor::stripSourceCode($sourceCode);
	$sourceCode = documentor::pretifySourceCode($strippedCode, $updated_manual, $appObj->getLibrary(), $appObj->getPackage(), $appObj->getNamespace());
}

// Update Source Code
$status = $appObj->updateSourceCode($sourceCode);
