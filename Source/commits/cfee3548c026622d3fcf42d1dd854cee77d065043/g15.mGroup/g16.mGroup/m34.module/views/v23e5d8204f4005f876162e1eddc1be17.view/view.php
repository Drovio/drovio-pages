...
{
	$status = $module->updateCSSCode($_POST["moduleCSS"]);
...
$sForm->build($moduleID, "moduleCSSEditor", $controls = FALSE);
...
$module_attr['title'] = $module->getTitle().":Style";
$module_attr['ref'] = "m_".$module_id."_style";
...
$content = $module->getCSSCode();
$editor = $coder->build($type = "css", $content, "moduleCSS")->get();
