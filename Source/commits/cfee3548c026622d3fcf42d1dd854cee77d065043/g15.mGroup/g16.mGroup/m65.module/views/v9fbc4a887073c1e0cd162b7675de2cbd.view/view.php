...
//_____ View Information
$tabID = $objID."_info";
$tabHeader = moduleLiteral::get($moduleID, "lbl_viewInfo");
$viewInfoContainer = DOM::create("div", "", "", "viewJS tabPageContent");
$tabber->insertTab($tabID, $tabHeader, $viewInfoContainer, $selected = FALSE);
...
// Info Tab
$innerForm = $form->build($moduleID, "updateInfo", FALSE)->get();
DOM::append($viewInfoContainer, $innerForm);
...
DOM::append($editorOuterContainer, $headersContainer);
...
foreach ($innerModules as $key => $iCode)
{
	// Grid List Contents
	$gridRow = array();
	$gridRow[] = $key;
