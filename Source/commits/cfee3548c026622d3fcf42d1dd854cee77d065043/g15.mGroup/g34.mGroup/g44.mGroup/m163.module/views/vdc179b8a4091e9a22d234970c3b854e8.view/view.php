...
$actionFactory->setModuleAction($tlb_devPrivs_item, $innerModules['devPrivileges'], '', '.uiMainContent');
...
// Load Default Page
$content = $page->getModuleContainer($innerModules['devPrivileges'], "", $attr = array(), TRUE, $containerID = "");
