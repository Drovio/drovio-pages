...
{	
	...
	$srcObject = $devApp->getSrcObject($_POST['package'], $_POST['namespace']);
...
$frame->build($title, $moduleID, "createSrcObject", FALSE);
$form = new simpleForm();
...
$appSrcPkg = $devApp->getSrcPackage();
$packages = $appSrcPkg->getPackages($fullNames = TRUE);
