...
function getSessionElement($moduleID, $session, $sForm, $type = "li", $includeDate = TRUE)
{
...
foreach ($sessions as $session)
{
	if ($session['id'] == account::getSessionID())
		DOM::append($currentSession, getSessionElement($moduleID, $session, $sForm, "div", FALSE));
	else
