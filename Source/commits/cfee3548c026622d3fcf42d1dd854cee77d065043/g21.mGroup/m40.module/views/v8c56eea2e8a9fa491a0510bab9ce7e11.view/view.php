...
$actionFactory->setModuleAction($menuItem, $moduleID, "generalSettings", "#settingsContainer");

// Security Settings
$title = moduleLiteral::get($moduleID, "lbl_securitySettings");
$menuItem = $menu->insertListItem($id = "securitySettings", $title);
$menu->addNavigation($menuItem, "", "", "", $navGroup, $navDisplay);
//$actionFactory->setModuleAction($menuItem, $moduleID, "personalInfo", "#settingsContainer");
...
if (empty($section))
{
	$personalContainer = $page->getModuleContainer($moduleID, $action = "generalSettings", $attr = array(), $startup = TRUE, $containerID = "");
