...
$optResource = array();
$rsrcSelected = moduleLiteral::get($moduleID, "lbl_subjSupport", FALSE);
$optResource[$rsrcSelected] = $rsrcSelected;
$rsrc = moduleLiteral::get($moduleID, "lbl_subjFeedback", FALSE);
$optResource[$rsrc] = $rsrc;
$rsrc = moduleLiteral::get($moduleID, "lbl_subjCollaboration", FALSE);
$optResource[$rsrc] = $rsrc;
$rsrc = moduleLiteral::get($moduleID, "lbl_subjBug", FALSE);
$optResource[$rsrc] = $rsrc;
