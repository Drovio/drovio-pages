...
// Try to Load Object
$pageObject = $extensionObject->getSrcObject($_GET['pkg'], $_GET['objName'], $_GET['ns']);
...
$sForm->build($innerModules['extensionObject'], "saveClassOblect", $controls = FALSE);
...
$attr['id'] = $extensionID;
$attr['name'] = $viewName;
$actionFactory->setModuleAction($commitTool, $innerModules['extensionObject'], "commitClassObject", "", $attr);
...
$input = $sForm->getInput($type = "text", $name = "viewName", $viewName, $class = "", $autofocus = TRUE);
...
// Prepare report
// Send redWIDE Tab
$obj_id = "Obj_".$_GET['pkg']."_".$_GET['ns']."_".$_GET['objName'];
$header = "Obj::".$_GET['objName'];
$WIDETab = new redWIDE();
