...
windowFrame::setAction($deleteStructureControl, $innerModules['templateObject'], 'deletePageStructure', array('templateId' => $templateID, 'pageStructure' => $pageStructureName));
