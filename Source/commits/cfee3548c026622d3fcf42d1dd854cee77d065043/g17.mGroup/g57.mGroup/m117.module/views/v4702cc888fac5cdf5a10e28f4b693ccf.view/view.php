...
$addPageStructureFormElement = $addPageStructureFormObject->build($moduleID, "newTheme", $controls = TRUE);
...
$input = $addPageStructureFormObject->getInput($type = "text", $name = "themeName", $value = "", $class = "", $autofocus = FALSE);
