...
DOM::append($sectionHeaderWrapper, moduleLiteral::get($moduleID, "actSet_ebldUsersHeader"));
DOM::append($contentPage, $sectionHeaderWrapper);
	...
	$leftSideWrapper = DOM::create('div', '', '', 'leftSideWrapper aCenter');
		...
		DOM::append($titleWrapper, moduleLiteral::get($moduleID, "staticTempWiz_hd"));	
	...
	$rightSideWrapper = DOM::create('div', '', '', 'rightSideWrapper');
		...
		DOM::append($headweWrapper, moduleLiteral::get($moduleID, "staticTempWiz_hd"));
		DOM::append($rightSideWrapper, $headweWrapper);		
		//#######Create Content
		$textWrapper = DOM::create('div','', '', 'content');
		DOM::append($textWrapper, moduleLiteral::get($moduleID, "staticTempWiz_content"));	
	...
	$leftSideWrapper = DOM::create('div', '', '', 'leftSideWrapper aCenter');
		...
		//#######Create Title Text
		$titleWrapper = DOM::create('div','', '', 'title');
		DOM::append($titleWrapper, moduleLiteral::get($moduleID, "dynamicTempWiz_hd"));	
	...
	$rightSideWrapper = DOM::create('div', '', '', 'rightSideWrapper');
		//Hd
		$headweWrapper = DOM::create('h4','', '', 'ebulderTitleSet_2 underBorder');
		DOM::append($headweWrapper, moduleLiteral::get($moduleID, "dynamicTempWiz_hd"));
		DOM::append($rightSideWrapper, $headweWrapper);		
		//#######Create Content
		$textWrapper = DOM::create('div','', '', 'content');
		DOM::append($textWrapper, moduleLiteral::get($moduleID, "dynamicTempWiz_content"));	
		DOM::append($rightSideWrapper, $textWrapper);			
	DOM::append($tileContent, $rightSideWrapper);
	...
	$leftSideWrapper = DOM::create('div', '', '', 'leftSideWrapper aCenter');
		...
		//#######Create Title Text
		$titleWrapper = DOM::create('div','', '', 'title');
		DOM::append($titleWrapper, moduleLiteral::get($moduleID, "freeCreator_hd"));	
		DOM::append($leftSideWrapper, $titleWrapper);
	DOM::append($tileContent, $leftSideWrapper);
	...
	$rightSideWrapper = DOM::create('div', '', '', 'rightSideWrapper');
		//Hd
		$headweWrapper = DOM::create('h4','', '', 'ebulderTitleSet_2 underBorder');
		DOM::append($headweWrapper, moduleLiteral::get($moduleID, "freeCreator_hd"));
		DOM::append($rightSideWrapper, $headweWrapper);		
		//#######Create Content
		$textWrapper = DOM::create('div','', '', 'content');
		DOM::append($textWrapper, moduleLiteral::get($moduleID, "freeCreator_content"));	
		DOM::append($rightSideWrapper, $textWrapper);		
	DOM::append($tileContent, $rightSideWrapper);
