...
// Build the module
$page->build("Limpakos Testing", "uc");

$holder = DOM::create("div", "Get popup file explorer");
$actionFactory->setPopupAction($holder, $moduleID, "auxTesting");


/*
// Ebuilder website
$website = new website();
$website->create("testSite");
*/

/*// HTMLEditor
$htmlEditor = new HTMLEditor();
$holder = $htmlEditor->build("test", "htmlContent", HTMLEditor::HTML_DESIGNER)->get();
*/
