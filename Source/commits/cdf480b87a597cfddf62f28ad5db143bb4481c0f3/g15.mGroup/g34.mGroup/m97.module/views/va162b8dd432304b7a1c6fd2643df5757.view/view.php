...
$page->build("Module Manager", "moduleSecurityPage", TRUE);

$sidebar = HTML::select(".moduleSecurityPage .uiMainSideNav")->item(0);
$mainNav = HTML::select(".moduleSecurityPage .uiMainContent")->item(0);
...
foreach ($moduleGroups as $group)
{
	...
	$attr = array();
	$attr['gid'] = $group['id'];
	$actionFactory->setModuleAction($groupName, $moduleID, "moduleViewer", "#moduleViewer", $attr);
}
