...
foreach ($similarObjects as $sObject)
{
	...
	$href = url::resolve("developers", "/docs/sdk/".$objectDomain."/".$sObject['library']."/".$sObject['package']."/".(empty($objectNs) ? "" : $objectNs."/").$sObject['name']);
	$sTitle = $pageContent->getWeblink($href, $sObject['name'], "_self");
