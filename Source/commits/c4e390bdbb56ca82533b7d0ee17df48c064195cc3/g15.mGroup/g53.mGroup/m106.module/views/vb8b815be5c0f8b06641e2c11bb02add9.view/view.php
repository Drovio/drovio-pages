...
$title = moduleLiteral::get($moduleID, "lbl_panelTitle");
$header = HTML::select(".devPanel .title")->item(0);
DOM::append($header, $title);

// Get project container
$projectContainer = HTML::select(".devPanel .projects")->item(0);
...
{
	$projectRow = DOM::create("div", "", "", "projectRow");
	
	$projectTitle = DOM::create("h4", $project['title']);
	DOM::append($projectRow, $projectTitle);
...
// Logger priority
$prioritySwitchRow = DOM::create("div", "", "", "switchRow f-right logPriorityRow".(logger::status() ? "" : " noDisplay"));
