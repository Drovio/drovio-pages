...
foreach ($packages as $packageID => $packageData)
{
	...
	$lit = moduleLiteral::get($moduleID, "lbl_showBuildHistory");
	$showHistory = DOM::create("span", $lit, "", "showHistory");
	DOM::append($historyContainer, $showHistory);
	
	$lit = moduleLiteral::get($moduleID, "lbl_hideBuildHistory");
	$hideHistory = DOM::create("span", $lit, "", "hideHistory");
	...
	$packageReleases = array_slice($packageReleases, 1, count($packageReleases)-1, TRUE);
