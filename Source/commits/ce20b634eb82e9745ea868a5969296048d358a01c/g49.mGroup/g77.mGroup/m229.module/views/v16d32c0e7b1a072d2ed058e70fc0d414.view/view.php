...
$severity->nodeValue = bugTracker::getSeverityName($issue["severity"]);

$priority = HTML::select('.window-module.info .content > .row.priority .rowValue')->item(0);
$priority->nodeValue = bugTracker::getPriorityName($issue["priority"]);
...
$changeBugPriority = module::loadview($moduleID, "changeBugPriority");
DOM::append($actionList, $changeBugPriority);

$changeBugSeverity = module::loadview($moduleID, "changeBugSeverity");
DOM::append($actionList, $changeBugSeverity);

$assignBug = module::loadview($moduleID, "assignBug");
DOM::append($actionList, $assignBug);
