...
jq(document).one("ready", function() {
	...
	jq(document).on("appcenter.sidebar.close", function() {
		jq(".sidebarContainer").removeClass("openSidebar");
	});
	
	// Open sidebar listener
	jq(document).on("appcenter.sidebar.open", function() {
		jq(".sidebarContainer").addClass("openSidebar");
	});
