...
// Create steps to publish
$createReleasePackage = HTML::select(".createReleasePackage")->item(0);
// Step 3. Create release package
$title = moduleLiteral::get($moduleID, "lbl_createReleasePackage");
$header = HTML::select(".createReleasePackage .header")->item(0);
HTML::append($header, $title);


$form = new simpleForm();
$releaseForm = $form->build($moduleID, "createReleasePackage")->get();
HTML::append($createReleasePackage, $releaseForm);
