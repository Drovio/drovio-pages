...
// Build module page
$page->build("Repository Overview  | ".$projectTitle, "projectRepositoryPage", TRUE);
...
$fExplorer = new fileExplorer($headPath, "vcsOvExplorer_".$projectID, $projectTitle, $showHidden = TRUE);
