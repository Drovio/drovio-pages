...
if (engine::isPost())
{
	...
	if (classDocumentor::isValidDocumentation($manual))
	{
		...
		$sourceCode = classComments::pretifySourceCode($strippedCode, $updated_manual, $sdkObj->getLibrary(), $sdkObj->getPackage(), $sdkObj->getNamespace(), $copyright = $appInfo['title']);
	}
