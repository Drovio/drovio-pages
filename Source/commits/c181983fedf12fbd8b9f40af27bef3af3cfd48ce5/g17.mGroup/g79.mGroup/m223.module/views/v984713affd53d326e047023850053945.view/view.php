...
if (engine::isPost())
{
	...
	$wsSettings->setMetaDescription($_POST['description']);
	$wsSettings->setMetaKeywords($_POST['keywords']);
...
$metaDescription = $wsSettings->getMetaDescription();
...
$metaKeywords = $wsSettings->getMetaKeywords();
...
$value = $wsSettings->get("meta_og_enabled");
if ($value)
...
$value = $wsSettings->get("meta_og_sitename");
...
$value = $wsSettings->get("meta_og_type");
...
$value = $wsSettings->get("meta_og_image");
