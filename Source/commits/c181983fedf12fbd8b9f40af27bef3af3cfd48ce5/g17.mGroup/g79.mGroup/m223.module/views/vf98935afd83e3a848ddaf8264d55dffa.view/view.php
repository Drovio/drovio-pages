...
if (engine::isPost())
{
	...
	$wsSettings->set("meta_og_enabled", $_POST['enabled']);
	$wsSettings->set("meta_og_sitename", $_POST['site_name']);
	$wsSettings->set("meta_og_type", $_POST['type']);
	$wsSettings->set("meta_og_image", $_POST['image']);
