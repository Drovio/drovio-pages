...
// Build the content
$page->build("", "consoleContainer", TRUE);
...
{
	// Add hidden value to form
	$input = $form->getInput($type = "hidden", $name = "hid", $value = $history_id, $class = "", $autofocus = FALSE, $required = FALSE);
	$form->append($input);
}*/
...
$page->addReportAction("switch.nav", "mi_console");
