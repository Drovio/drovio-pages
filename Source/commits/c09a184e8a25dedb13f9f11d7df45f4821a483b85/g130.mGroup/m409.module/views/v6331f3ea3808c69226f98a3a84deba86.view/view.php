...
// Add open graph meta
$og = array();
$og['title'] = "Drovio Blog";
$og['site_name'] = "Drovio Blog";
$og['url'] = "http://blog.drov.io";
$og['description'] = "Everything you need to know about Identity Infrastructure, Access Management and Authentication. Company updates & Technology articles...";
// Temp image url
$og['image'] = resource::getUrl("/media/blog/wblog.svg");
...
foreach ($blog_docs as $docName)
{
	...
	if (!empty($docInfo) && !empty($docInfo['title']))
...
$footerContainer = HTML::select(".blogHomePage")->item(0);
$footerBar = $page->loadView($innerModules['landingPage'], "footerBar");
DOM::append($footerContainer, $footerBar);
