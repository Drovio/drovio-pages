...
// Load navigation bar
$landingPage = HTML::select(".landingPage .section-home")->item(0);
...
$input = $form->getInput($type = "hidden", $name = "origin", $value = "page", $class = "", $autofocus = FALSE, $required = TRUE);
$form->append($input);
...
$footerBar = $page->loadView($moduleID, $viewName = "footerBar");
DOM::append($landingPage, $footerBar);
