...
foreach ($teamProjects as $project)
{
	...
	if ($project['projectType']>= 1 && $project['projectType']<=3)
	{
		$red_count++;
		HTML::addClass($projectBox,"redback");
	}
	elseif ($project['projectType']==4)
	{
		$app_count++;
		HTML::addClass($projectBox,"apps");
	}
	elseif ($project['projectType']==5)
	{
		$web_count++;
		HTML::addClass($projectBox,"websites");
	}
	elseif ($project['projectType']==6)
	{
		$template_count++;
		HTML::addClass($projectBox,"templates");
	}
	elseif ($project['projectType']==7)
	{
		$extension_count++;
