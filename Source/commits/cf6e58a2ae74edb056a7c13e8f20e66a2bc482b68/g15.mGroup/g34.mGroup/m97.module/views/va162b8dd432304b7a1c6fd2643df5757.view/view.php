...
$pageContent->build("", "moduleSecurityPage", TRUE);
$actionFactory = $pageContent->getActionFactory();


$sidebar = HTML::select(".moduleSecurityPage .sidebar")->item(0);
$mainNav = HTML::select(".moduleSecurityPage .mainContent")->item(0);
