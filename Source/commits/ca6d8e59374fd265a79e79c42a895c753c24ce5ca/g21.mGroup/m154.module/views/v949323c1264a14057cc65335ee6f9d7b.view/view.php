...
// Set links
$profileItem = HTML::select(".accountInfo .scitem.profile")->item(0);
HTML::attr($profileItem, "href", $profileLink);

$settingsItem = HTML::select(".accountInfo .scitem.settings")->item(0);
...
$logoutSubmit = $form->getInput($type = "submit", $name = "logout", $value = " ", $class = "logoutButton", $autofocus = FALSE);
