...
if (empty($accountName) && !empty($accountInfo['username']))
{
...
$page->build($accountInfo['title'], "profileHomePage", TRUE);
...
if (empty($pendingInvitations))
{
	...
	$relationsBox = HTML::select(".profileHome section.box.relations")->item(0);
