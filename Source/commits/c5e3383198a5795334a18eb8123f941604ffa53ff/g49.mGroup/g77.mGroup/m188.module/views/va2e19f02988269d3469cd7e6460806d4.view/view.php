...
$sections["working_items"] = "repositoryWorkingItems";
...
$witems = $vcs->getAllWorkingItems(vcs::MASTER_BRANCH);
$countItem = DOM::create("span", " (".count($witems).")");
$navItem = HTML::select(".projectRepository .menu .menu_item.working_items")->item(0);
DOM::append($navItem, $countItem);
