...
// Build the module
$pageContent->build("", "templateDesigner");
...
$mContainer = $pageContent->getModuleContainer($moduleID, "templateExplorer", $attr, $startup = TRUE, $containerID = "", $loading = FALSE, $preload = TRUE);
