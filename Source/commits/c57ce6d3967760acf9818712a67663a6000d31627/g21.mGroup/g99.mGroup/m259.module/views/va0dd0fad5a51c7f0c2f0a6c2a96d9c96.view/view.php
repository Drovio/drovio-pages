...
foreach ($teams as $team)
{
	if ($team['id'] == team::getTeamID())
	{
		...
		// Set team manager if account is admin
		...
		{
			// Replace team manager button and container
			$manageButton = HTML::select(".teamEditor .manage")->item(0);
			HTML::replace($manageButton, NULL);
			HTML::replace($membersContainer, NULL);
		}
	}
...
if (account::isAdmin())
{
	...
	HTML::replace($createTeamContainer, NULL);
