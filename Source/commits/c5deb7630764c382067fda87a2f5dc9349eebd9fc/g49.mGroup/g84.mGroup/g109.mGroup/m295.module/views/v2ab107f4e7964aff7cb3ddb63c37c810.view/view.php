...
foreach ($navItems as $item)
{
	...
	// Static navigation
	$page->setStaticNav($navItem, $ref, "securityContainer", $targetgroup, "cscNav", $display = "none");
	
	// Add Module Container
	$securityContainer = HTML::select("#securityContainer")->item(0);
	$attr = array();
	$attr['id'] = coreProject::PROJECT_ID;
	$mContainer = $page->getModuleContainer($innerModules[$item], "", $attr, $startup = TRUE, $containerID = $ref, $loading = TRUE, $preload);
