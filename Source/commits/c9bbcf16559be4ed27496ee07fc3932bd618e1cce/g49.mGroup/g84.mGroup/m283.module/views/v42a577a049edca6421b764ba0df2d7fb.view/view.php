...
$switchObject = $switch->build("", ajaxTester::status())->engageModule($moduleID, "ajaxTesting")->get();
DOM::append($switchRow, $switchObject);

// SQL switch
$switchRow = HTML::select(".switchRow.sql")->item(0);
$switch = new switchButton("sqlTestSwitch");
$switchObject = $switch->build("", sqlTester::status())->engageModule($moduleID, "sqlTesting")->get();
DOM::append($switchRow, $switchObject);
