...
foreach ($apps as $app)
{
	...
	$appIcon = projectLibrary::getPublishedPath($app['application_id'], $app['version'])."/resources/.assets/icon.png";
	...
	$attr = array();
	$attr['id'] = $app['application_id'];
	$attr['version'] = $app['version'];
	$actionFactory->setModuleAction($appBox, $moduleID, "appDetails", "", $attr);
