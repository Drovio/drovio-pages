...
foreach ($releases as $projectRelease)
{
	...
	$projectTile = DOM::create("div", "", "", "releaseRow");
	...
	if ($projectRelease['status_id'] == 1)
	{
		...
		$reviewForm = $form->build("", FALSE)->engageModule($moduleID, "revokeProject")->get();
