...
// Create Code Container (With Documentation)
$objManualContainer = DOM::create("div", "", "objManualContainer");
DOM::append($obj_container, $objManualContainer);

$structure = $sdkObj->getManual();
$editor = new cssEditor("", "objectManual");
$htmleditor = $editor->build($structure, $code)->get();
