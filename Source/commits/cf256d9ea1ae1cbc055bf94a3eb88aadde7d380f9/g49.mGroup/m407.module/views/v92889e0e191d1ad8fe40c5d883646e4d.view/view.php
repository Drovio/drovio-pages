...
foreach ($allRoadmaps as $rdInfo)
{
	...
	// Hashtag link
	$href = url::resolve("developers", "/roadmap/#".$rdInfo['hashtag']);
	$rhash = $pageContent->getWeblink($href, "#", $target = "_self", $moduleID = NULL, $viewName = "", $attr = array(), $class = "rhash");
	DOM::append($ritem, $rhash);
