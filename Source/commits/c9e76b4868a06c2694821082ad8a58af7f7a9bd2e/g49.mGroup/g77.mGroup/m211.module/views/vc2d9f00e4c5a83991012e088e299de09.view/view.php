...
if (engine::isPost())
{
	...
	foreach ($accountIDs as $accountInfo => $nothing)
	{
		...
		invitations::create($accountMail, $projectID, invitations::PROJECT_TYPE);
		...
		$status = mMail::send("/mail/invitations/project_invitation_user.html", $subject, $accountMail, $attr);
	}
