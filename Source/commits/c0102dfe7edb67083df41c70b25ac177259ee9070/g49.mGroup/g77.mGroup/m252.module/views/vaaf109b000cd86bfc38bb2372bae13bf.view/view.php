...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$reportHolder = "#".$tID." .translations";
		
	// Check Action
	if ($_POST['action'] == "translate")
		translator::translate($projectID, $literalScope, $literalName, $_POST['translationValue']);
...
$translations = translator::getTranslations($projectID, $literalScope, $literalName);
