...
foreach ($projects as $project)
{
	...
	$devProjectConfigurator = $pageContent->getModuleContainer($configModuleID, $action = "", $attr, $startup = TRUE, $containerID = "devProjectConfigurator_prj".$project['id']);
