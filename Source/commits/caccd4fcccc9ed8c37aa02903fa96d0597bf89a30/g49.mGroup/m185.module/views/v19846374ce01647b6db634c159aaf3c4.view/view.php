...
foreach ($allProjects as $project)
{
	...
	$teamNameElement = DOM::create("h3", $teamName, "", "teamName");
	HTML::append($boxHeader, $teamNameElement);
	...
	if (isset($myProjects[$project['id']]) || isset($sharedProjects[$project['id']]))
	{
		...
		// Info button
		$infoButton = DOM::create("div", "", "", "ba info");
		DOM::append($boxActions, $infoButton);
		$infoIco = DOM::create("span", "", "", "ico");
		DOM::append($infoButton, $infoIco);
		$title = moduleLiteral::get($moduleID, "lbl_projectInfo");
		DOM::append($infoButton, $title);
