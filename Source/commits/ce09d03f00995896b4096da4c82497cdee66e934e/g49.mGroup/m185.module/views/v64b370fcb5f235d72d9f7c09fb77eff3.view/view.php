...
if (engine::isPost())
{
	...
	$projectHomeUrl = (empty($projectName) ? "/projects/project.php?id=".$projectID : "/projects/".$projectName."/");
	return $actionFactory->getReportRedirect($projectHomeUrl, "developer", TRUE);
}
