...
if (engine::isPost())
{
	...
	$q = $pageContent->getQuery("add_account_to_project");
	$attr = array();
	$attr['aid'] = $accountID;
	$attr['pid'] = $projectID;
	...
	if (empty($projectName))
	{
		$params = array();
		$params['id'] = $projectID;
		$projectHomeUrl = url::resolve("developers", "/dashboard/project.php", $params);
	}
	else
		$projectHomeUrl = url::resolve("developers", "/dashboard/".$projectName."/");
