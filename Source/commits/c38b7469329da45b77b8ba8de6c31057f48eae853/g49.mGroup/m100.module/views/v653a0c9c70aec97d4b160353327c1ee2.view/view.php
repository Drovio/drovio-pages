...
// Build the module
$pageContent->build("toolbarDeveloperNav", "developerNavContainer", TRUE);
...
// Get teams
$teamList = HTML::select(".developerNav .teamList")->item(0);
$projectListContainer = HTML::select(".developerNav .projectList")->item(0);
...
// My Dashboard Home
$item = HTML::select(".devDashboard")->item(0);
