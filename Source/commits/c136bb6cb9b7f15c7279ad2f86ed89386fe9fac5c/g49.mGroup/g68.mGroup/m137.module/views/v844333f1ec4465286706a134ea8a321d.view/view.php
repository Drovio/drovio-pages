...
$params = array();
$params['id'] = $appID;
$cssUrl = url::resource("/ajax/apps/css.php");
$jsUrl = url::resource("/ajax/apps/js.php");

// Add Header
$header = BootLoader::getResourceArray("ApplicationTester", "ApplicationTester", $appID, $cssUrl, $jsUrl, $tester = TRUE);
