...
$page->build($title, "RedbackTermsPage", TRUE);


// Load Terms of Use Document
$wDoc = new wDoc("", "Policies/Terms", $public = TRUE, $teamID = 6);
$documentContent = $wDoc->load($locale = NULL);

$docContainer = HTML::select(".termsPage .docContainer")->item(0);
...
// Load footer menu
$discoverPage = HTML::select(".termsPage")->item(0);
