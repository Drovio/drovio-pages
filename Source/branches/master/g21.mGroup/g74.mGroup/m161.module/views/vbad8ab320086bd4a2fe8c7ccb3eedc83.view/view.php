...
if (engine::isPost())
{
	...
	accountSession::getInstance()->remove(account::getInstance()->getAccountID(), $sessionID);
}
$sessions = accountSession::getInstance()->getActiveSessions(account::getInstance()->getAccountID());
