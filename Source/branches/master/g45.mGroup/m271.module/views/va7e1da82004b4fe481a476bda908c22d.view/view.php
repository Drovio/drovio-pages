...
$appIcon = projectLibrary::getPublishedPath($appID, $appVersion)."/resources/.assets/icon.png";
...
if (!empty($teamID) && accountKey::validateGroup("TEAM_ADMIN", $teamID, accountKey::TEAM_KEY_TYPE))
{
