...
$objectTabberControl = $objectTabber->build($id = "tbr_".$objID, $full = FALSE, $withBorder = FALSE)->get();
HTML::addClass($objectTabberControl, "appSourceTabControl");
...
// Source Code Editor
$editor = new codeMirror(codeMirror::JS);
