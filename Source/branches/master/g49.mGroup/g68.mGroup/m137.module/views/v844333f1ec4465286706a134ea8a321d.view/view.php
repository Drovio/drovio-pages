...
$cssUrl = BootLoader::getTesterResourceUrl("/ajax/apps/css.php", $appID);
$jsUrl = BootLoader::getTesterResourceUrl("/ajax/apps/js.php", $appID);
$header = BootLoader::getResourceArray(application::PROJECT_TYPE, "ApplicationSourceTester", $appID, $cssUrl, $jsUrl, $tester = TRUE);
...
{
	$cssUrl = BootLoader::getTesterResourceUrl("/ajax/apps/lib/css.php", $appID, $styleName);
	$header = BootLoader::getResourceArray(application::PROJECT_TYPE, "ApplicationLibraryCSSTester", $appID, $cssUrl, NULL, $tester = TRUE);
	$pageContent->addResourceHeader($header['id'], $header);
}
...
{
	$jsUrl = BootLoader::getTesterResourceUrl("/ajax/apps/lib/js.php", $appID, $scriptName);
	$header = BootLoader::getResourceArray(application::PROJECT_TYPE, "ApplicationLibraryJSTester", $appID, NULL, $jsUrl, $tester = TRUE);
	$pageContent->addResourceHeader($header['id'], $header);
}
