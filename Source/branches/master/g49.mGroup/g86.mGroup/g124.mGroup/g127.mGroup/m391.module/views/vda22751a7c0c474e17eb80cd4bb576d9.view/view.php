...
$themeCSS = new templateThemeCSS($templateID, $themeName, $cssName);
if (engine::isPost())
{
	// Update css
...
// Load Page Code
$editor = new codeMirror($type = codeMirror::CSS, $name = "cssCode");
$cssEditor = $editor->build($themeCSS->get(), "", "cmEditor")->get();
DOM::append($globalContainer, $cssEditor);

// Get Content
$obj_id = str_replace(".", "_", $templateID."_".$themeName."_css_".$cssName);
$header = $themeName."/".$cssName.".scss";
