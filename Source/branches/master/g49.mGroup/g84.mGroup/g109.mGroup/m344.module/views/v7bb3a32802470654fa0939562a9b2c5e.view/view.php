...
uasort($manifestList, "sort_manifests");
...
// Sort manifest function per manifest name
function sort_manifests($mfA, $mfB)
{
	// Check if equal
	if ($mfA['info']['name'] == $mfB['info']['name'])
		return 0;
	
	// Compare
	return ($mfA['info']['name'] < $mfB['info']['name']) ? -1 : 1;
}
//#section_end#
?>