...
// Get project info
$project = new coreProject($projectID, $projectName);
...
$whiteBox = HTML::select(".coreTester .whiteBox")->item(0);
...
{
	$ref = $class."_ref";
	$navItem = HTML::select(".coreTester .menu .menu_item.".$class)->item(0);
	$page->setStaticNav($navItem, $ref, $targetcontainer = "ctContainer", $targetgroup = "mGroup", $navgroup = "ct_group", $display = "none");
