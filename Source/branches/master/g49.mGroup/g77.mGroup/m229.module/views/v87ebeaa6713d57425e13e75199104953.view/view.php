...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$success = $bugger->setStatus($_POST['bid'], $_POST['status']);
...
// Build the module 
$MContent->build("", "changeBugStatus inlineForm", TRUE);

$formContent = HTML::select('.changeBugStatus .actionForm ')->item(0);

$sForm = new simpleForm();
$sForm->build($moduleID, "changeBugStatus", FALSE);
...
$input = $sForm->getResourceSelect("status", $multiple = FALSE, $class = "", $resource, bugTracker::ST_ACK );
