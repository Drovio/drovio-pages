...
foreach ($locales as $locale)
{
	...
	$countersText = $localeCount." Translated literal(s) / <b>".($percentage)."%</b>";
...
$countersText = ($totalCount)." Total literal(s) / <b>".($percentage)."%</b>";
...
function getLocaleViewer($name, $imageUrl, $countersText, $percentage)
{
	...
	// Counters
	$counters = DOM::create("div", "", "", "counters");
	DOM::innerHTML($counters, $countersText);
