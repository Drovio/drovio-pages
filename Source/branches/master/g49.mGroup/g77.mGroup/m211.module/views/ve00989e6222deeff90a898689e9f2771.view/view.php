...
// Group id
$projectGroupsResource = array();
$projectGroups = privileges::getPermissionGroups();
foreach ($projectGroups as $groupID => $groupName)
	if (preg_match('/PROJECT_.*/', $groupName))
		$projectGroupsResource[$groupID] = $groupName;
