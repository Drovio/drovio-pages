...
$innerModules['webTemplateDesigner'] = 387;
...
// Set project id
DOM::data($page->get(), "project-id", $projectID);
...
// Add project hints if enabled
$attr = array();
$attr['id'] = $projectID;
$hints = $page->getModuleContainer($moduleID, $action = "hintsPopup", $attr, $startup = FALSE, $containerID = "projectHintsContainer");
$page->append($hints);
