...
$page->build($appInfo['title'], "applicationEmbeddedPlayer", TRUE);
$applicationContainer = HTML::select(".applicationEmbedPlayer #applicationContainer")->item(0);
