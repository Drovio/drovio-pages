...
if (engine::isPost())
{
	...
	$status1 = $wsServer->update($_POST['name'], $_POST['address']);
	$status2 = $wsServer->updateInfo($_POST['description'], $_POST['type'], $_POST['connection'], $_POST['httpdocs']);
	$status3 = $wsServer->updateCredentials($_POST['username'], $_POST['password']);
...
$form = new simpleForm();
$serverForm = $form->build("", TRUE)->engageModule($moduleID, "serverEditor")->get();
