...
if (engine::isPost())
{
	...
	// Get template
	$activeTemplate = $_POST['active_template'];
	list($templateName, $templateThemeName) = explode(".", $activeTemplate);
	$wsSettings->set('template_name', $templateName);
	$wsSettings->set('template_theme_name', $templateThemeName);
