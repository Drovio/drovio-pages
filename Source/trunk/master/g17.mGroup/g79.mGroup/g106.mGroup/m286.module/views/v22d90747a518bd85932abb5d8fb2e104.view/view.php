...
$input = $form->getTextArea("settings[meta_description]", $value, "", $autofocus = FALSE, $required = FALSE);
$row = $form->buildRow($title, $input, $required = FALSE, $notes = "");
DOM::append($formContainer, $row);
...
$input = $form->getTextArea("settings[meta_keywords]", $value, "", $autofocus = FALSE, $required = FALSE);
$row = $form->buildRow($title, $input, $required = FALSE, $notes = "");
DOM::append($formContainer, $row);
