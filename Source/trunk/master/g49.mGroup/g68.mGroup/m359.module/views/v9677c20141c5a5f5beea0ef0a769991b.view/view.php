...
$pageContent->build("", "apcAnalyticsPage", TRUE);
...
{
	$elem = HTML::select(".apcAnalytics .sessions .".$name." .value")->item(0);
...
if (count($detailedStats) > 0)
{
	...
	$detailedContainer = HTML::select(".apcAnalytics .details")->item(0);
