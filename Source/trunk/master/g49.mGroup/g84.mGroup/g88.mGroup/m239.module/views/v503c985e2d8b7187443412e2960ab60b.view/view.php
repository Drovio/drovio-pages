...
HTML::addClass($queryTabberControl, "sqlQueryTabControl");
...
// Query Page
$codeEditor = new codeMirror($type = codeMirror::SQL, "sqlQuery");
$sqlEditor = $codeEditor->build($dbq->getPlainQuery(), "", "cmEditor")->get();
