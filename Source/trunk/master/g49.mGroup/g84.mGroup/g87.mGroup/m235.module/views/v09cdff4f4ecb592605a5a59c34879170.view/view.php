...
HTML::addClass($objectTabberControl, "sdkObjectTabControl");
...
$objManualContainer = DOM::create("div", "", "", "objectManual");
...
// Source Code Editor
$editor = new codeMirror($type = codeMirror::PHP);
$code = $sdkObj->getSourceCode();
$class_editor = $editor->build($code, "", "cmEditor")->get();
...
// Source Code Editor
$editor = new codeMirror($type = codeMirror::JS);
$code = $sdkObj->getJSCode();
$js_editor = $editor->build($code, "", "cmEditor")->get();
...
$editor = new HTML5Editor($name = "objectManual", $enablePreview = TRUE);
