...
$menuItem = $tMenu->build("", "", "mNavTool create_new")->get();
...
$actionFactory->setModuleAction($menuItem, $moduleID, "newModuleGroup", "", $attr);

// New package
$title = moduleLiteral::get($moduleID, "hd_newModule");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "newModule", "", $attr);

// New namespace
$title = moduleLiteral::get($moduleID, "hd_newModuleView");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "newModuleView", "", $attr);

// New object
$title = moduleLiteral::get($moduleID, "hd_newModuleQuery");
$menuItem = $tMenu->insertMenuItem($title, $id = "");
$actionFactory->setModuleAction($menuItem, $moduleID, "newModuleQuery", "", $attr);
